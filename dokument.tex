...
\usepackage[bindingoffset=2cm,centering,includeheadfoot,margin=2cm,top=1.7cm,bottom=2cm,footskip=1.4cm]{geometry}
\usepackage{graphicx}
...
\newgeometry{twoside,includefoot,bottom=2cm}
\tableofcontents
\clearpage
